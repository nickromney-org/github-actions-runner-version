...
─────────────────────────────────────────────────────
Version    Released       Expires        Status
2.327.1    25 Jul 2024    24 Aug 2024    ❌ Expired 77 days ago  ← Your version
2.328.0    13 Aug 2024    12 Sep 2024    ❌ Expired 48 days ago
2.328.1    10 Sep 2024    13 Nov 2024    ✅ Valid (28 days left)
2.329.0    14 Oct 2024    -              ✅ Latest (2 days ago)
```
```
...
3. Ready for code review (use `superpowers:requesting-code-review`)
